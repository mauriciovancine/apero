...
subtitle: "Um passo a passo para gerar rasters de dados socioeconômicos para municípios do Brasil"
...
```r
# vetor
mun <- geobr::read_municipality(code_muni = "all", year = 2013, showProgress = FALSE)
