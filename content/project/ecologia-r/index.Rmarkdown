---
title: Ecologia no R
subtitle: Atualização e ampliação do livro "Análises Ecológicas no R", oferta 
  de cursos e doação de livros físicos
excerpt: Atualização e ampliação do livro "Análises Ecológicas no R", oferta 
  de cursos e doação de livros físicos
author: Fernando Rodrigues da Silva, Thiago Gonçalves-Souza, Gustavo Brant Paterno, 
  Diogo Borges Provete, Maurício Humberto Vancine
date: "2022-02-22"
layout: single
links:
  - icon: youtube
    icon_pack: fab
    name: youtube
    url: https://www.youtube.com/channel/UCLSVSCnmvf2k6OoWZCnEO4w
categories:
- Projeto
tags:
- R
