---
title: amphiBR
excerpt: Pacote R com dataset da publicação oficial da Lista de Anfíbios do Brasil publicada pela Sociedade Brasileira de Herpetologia
...
links:
  - icon: link
    icon_pack: fas
    name: site
    url: https://paulobarros.github.io/amphiBR/index.html
  - icon: github
    icon_pack: fab
    name: code
